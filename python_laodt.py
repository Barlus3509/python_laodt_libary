            ...
            if x < text_len and lao_text_arry[x] in payasana:
                ...
                if x < text_len and lao_text_arry[x] in vannayud:
                    ...
                    if x < text_len and lao_text_arry[x] in tuasakod:
                        ...
                        tps += lao_text_arry[x]
                        x += 1  
                elif x < text_len and lao_text_arry[x] in vannayud1:  #fixxxxxxxxxxxxxxxxx
                    tps += lao_text_arry[x]
                    x += 1
                    if x < text_len and lao_text_arry[x] in vannayud:
                        tps += lao_text_arry[x]
                    ...
                    if lao_text_arry[x] in tuasakod and not lao_text_arry[x+1] in sala2 + sala3 + sala4 + sala6 + sala7 + vannayud + vannayud1:
                        tps += lao_text_arry[x]
                        x += 1
                elif lao_text_arry[x] in tuasakod and not lao_text_arry[x+1] in sala2 + sala3 + sala4 + sala6 + sala7 + vannayud + vannayud1:
                    tps += lao_text_arry[x]
                    x += 1
